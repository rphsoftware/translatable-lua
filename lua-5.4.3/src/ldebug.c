...
/*
** Find a LT_UNC_NAME for the constant 'c'.
*/
...
/*
** Find a LT_UNC_NAME for the register 'c'.
*/
...
/*
** Find a LT_UNC_NAME for a 'C' value in an RK instruction.
*/
